...
class CartServiceTest {
    ...
    void getOrCreateActiveCart_returnsExistingCart() {
        Cart cart = Cart.builder().id(1L).status("ACTIVE").build();
    ...
    void addItemToCart_addsNewItem() {
        ...
        Cart cart = Cart.builder().id(10L).user(user).status("ACTIVE").build();
    ...
    void addItemToCart_increasesQuantityWhenItemExists() {
        Cart cart = Cart.builder().id(10L).status("ACTIVE").build();
